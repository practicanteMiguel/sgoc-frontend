...
import { useUpdateProfile } from '@/src/hooks/settings/use-profile';
      ...
      <form onSubmit={handleSubmit((d) => updateProfile.mutate(d))}>
        ...
        >
          ...
          <div className="p-5 flex flex-col gap-4">
            ...
            {([
              { name: 'position' as const, label: 'Cargo',     Icon: Briefcase, placeholder: 'Ej: Supervisor de Planta' },
              { name: 'phone'    as const, label: 'Teléfono', Icon: Phone,     placeholder: '+57 300 000 0000'       },
              ...
              <div key={name} className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{ ...FIELD_STYLE, borderColor: 'var(--color-border)' }}
                    onFocus={(e) => { e.target.style.borderColor = 'var(--color-secondary)'; e.target.style.boxShadow = '0 0 0 3px var(--color-secondary-muted)'; }}
            ...
            <div className="grid grid-cols-2 gap-3">
              {([
                ...
                { label: 'Campo',  value: user?.field ?? '—', Icon: MapPin },
        ...
        <button
          ...
          style={{
            background: !isDirty ? 'var(--color-surface-2)' : 'var(--color-primary)',

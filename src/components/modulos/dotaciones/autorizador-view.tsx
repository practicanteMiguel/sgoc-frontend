      ...
      >
        ...
        <div className="px-5 py-4 flex items-start justify-between gap-3 shrink-0" style={{ borderBottom: '1px solid #e5e7eb', background: '#f8fafc' }}>
          <div>
            ...
            <p className="text-base font-semibold" style={{ color: '#111827' }}>
              {solicitud.campo?.name ?? 'Campo'} - {formatDate(solicitud.fecha)}
            </p>
        ...
        {step === 'view' ? (
          <>
            ...
            {/* Export + Actions */}
            <div className="px-5 py-3 flex items-center justify-between gap-3 shrink-0" style={{ borderTop: '1px solid #e5e7eb', background: '#f8fafc' }}>
          ...
          /* ── Signing step ── */
          <div className="flex-1 overflow-y-auto min-h-0 px-5 py-5 flex flex-col gap-4">
